...
func newCmdLonghornctl() *cobra.Command {
	...
	cmd.PersistentFlags().StringVar(&globalOpts.Image, consts.CmdOptImage, consts.ImageLonghornCli, "Image containing longhornctl-local. Include only image name and tag when used with --image-registry.")
