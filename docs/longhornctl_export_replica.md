...
```
  ...
  -h, --help                    help for replica
      --image string            Image containing longhornctl-local. Include only image name and tag when used with --image-registry. (default "longhornio/longhorn-cli:v1.10.0-dev")
