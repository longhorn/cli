...
```
$ longhornctl checksum volume --name=v1 --namespace=longhorn-system
```

### Options

```
      --all                        Apply to all volumes
  ...
  -l, --log-level string           Log level (default "info")
      ...
      --node-id string             Compute snapshots for all volumes on the specified node
